...
class DefaultApi(object):
    ...
    def add_photo(self, user_id, data, **kwargs):  # noqa: E501
        """add_photo  # noqa: E501

        Adds a photo  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_photo(user_id, data, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.add_photo_with_http_info(user_id, data, **kwargs)  # noqa: E501
        else:
            (data) = self.add_photo_with_http_info(user_id, data, **kwargs)  # noqa: E501
            return data

    def add_photo_with_http_info(self, user_id, data, **kwargs):  # noqa: E501
        """add_photo  # noqa: E501

        Adds a photo  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_photo_with_http_info(user_id, data, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'data', 'name', 'created_at']  # noqa: E501
        ...
        if ('user_id' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `add_photo`")  # noqa: E501
        # verify the required parameter 'data' is set
        if ('data' not in local_var_params or
                local_var_params['data'] is None):
            raise ValueError("Missing the required parameter `data` when calling `add_photo`")  # noqa: E501
